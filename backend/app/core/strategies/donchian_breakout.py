...
class DonchianBreakoutStrategy(BaseStrategy):
    ...
    description = (
        "Ruptura del canal de Donchian (turtle): compra cuando el precio cierra "
        "por encima del máximo de los últimos LOOKBACK periodos y vende cuando "
        "cierra por debajo del mínimo del período."
    )
